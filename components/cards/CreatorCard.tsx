...
const CreatorCard = ({rank,creatorImg,creatorName,creatorEths}:Props) => {
  return (
    <div className='m-4 flex min-w-190 flex-col rounded-3xl border
    border-nft-gray-1 bg-white p-4 dark:border-nft-black-3 dark:bg-nft-black-3 minlg:min-w-240'>
